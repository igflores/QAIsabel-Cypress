import { calculatorPage } from '../../support/pages/Paypal/GX-31903-CalculadorComsiones.Page';
import { faker } from '@faker-js/faker';
import data from '../../fixtures/data/GX-31903-CalculadoraComision.json'
...
describe('GX-31903-�-paypal-comisiones-calcular-las-comisiones-para-enviar-y-recibir', () => {
	...
	it('31904 | TC01: Verificar poder Calcular la comisión cuando se introduce 1 caracter', () => {
		const {
			inputParaRecibir,
			inputParaEnviar,
			inputHayQueEnviar,
	...
	it('31904 | TC02: Verificar poder Calcular la comisión cuando se introduce 306 caracteres', () => {
	...
	it.skip('31904 | TC03: Verificar NO poder Calcular la comisión hay que Recibir cuando se introduce 307 caracteres', () => {
	...
	it.skip('31904 | TC04: Verificar NO poder Calcular la comisión hay que Enviar cuando se introduce 307 caracteres', () => {
	...
	it('31904 | TC05: Verificar poder Calcular la comisión cuando se introduce un numero negativo', () => {
		const { inputParaRecibir, inputParaEnviar, inputHayQueEnviar, inputCommissionParaRecibir, inputSeReciben, inputCommissionParaEnviar } =
			calculatorPage.get;
		calculatorPage.CommissionAndFeeDefault();
	...
	it('31904 | TC06: Verificar poder Calcular la comisión cuando se introduce el caracter "+" y luego un número', () => {
		const { inputParaRecibir, inputParaEnviar, inputHayQueEnviar, inputCommissionParaRecibir, inputSeReciben, inputCommissionParaEnviar } =
			calculatorPage.get;
		calculatorPage.CommissionAndFeeDefault();
		//* Para Valores Enteros
	...
	it('31904 | TC07: Validar que se muestre el mensaje de la BR cuando el input se envía vació', () => {
	...
	it('31904 | TC08: Validar que se muestre el mensaje de la BR cuando el input se borra el contenido', () => {
		const { inputParaRecibir, inputParaEnviar, LogMsgRecibir, LogMsgEnviar } = calculatorPage.get;
	...
	it.skip('31904 | TC09: Validar que se eliminen automáticamente cuando se ingresan caracteres especiales en el input que no sean ( “+” o “-”)', () => {
